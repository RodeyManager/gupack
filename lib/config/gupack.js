    ...
    initClean() {
        ...
        if (this.cleans.length > 0) {
            ...
            this.gulp.task('build._cleans', () => {
                return this.gulp.src(this.cleans).pipe(gulpClean({
                    read: true
                }));
            });
            //添加清理任务
    ...
    addEvent() {
        ...
        this.gulp.on('task_start', e => {
            ...
            let name = e.task,
                ...
                isRun = (task instanceof TaskNode || task instanceof TaskNodeFun) && task.run === true;
        ...
        function _doneNext() {
            ...
            if (!this.watch && !this.devServer) return process.exit(0);
